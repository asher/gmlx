...
# Ported from vllm/model_executor/models/diffusion_gemma.py (the multi-step
# structured-read loop) at ab3de6edf2 and modified for gmlx (Apache-2.0; see
# licenses/vllm-LICENSE). entropy_transfer_mask follows mlx-vlm's
