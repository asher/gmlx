...
fp16 precision tail, default 1024). Coverage is head_dim-128 attention
layers (hybrid archs convert those and leave recurrent layers untouched;
current qwen3.5/3.6 checkpoints use 256-dim heads and decline);
ineligible models keep fp16 KV with a
